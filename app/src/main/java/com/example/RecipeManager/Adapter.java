...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull Adapter.ViewHolder holder, int position) {
        ...
        String serves = "Serves : " + dataList.get(position).serves;
        String difficulty = "Difficulty : " + dataList.get(position).difficulty;
        Uri image = Uri.parse(dataList.get(position).imageUri);
